...
var movieroutes_v1 = require('./api/movies.routes.v1');
var actorroutes_v1 = require('./api/actors.routes.v1');
var roomroutes_v1 = require('./api/rooms.routes.v1');
...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', process.env.ALLOW_ORIGIN || 'https://bioscoopapp-client.herokuapp.com');
